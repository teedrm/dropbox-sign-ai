...
function MainPage() {
    ...
    //       <Heading>Audio-to-Agreement (change title later)</Heading>
    
    //       <FormControl as="form" method="post" encType="multipart/form-data">
    ...
    //       <Box id="transcription" bg={transcript === '' ? 'gray.100' : 'white'} p={4}>
    //         {transcript === '' ? (
    //           <Text>say something</Text>
    //         ) : (
    //           <>
    //             <Heading size="md">Transcribed Text:</Heading>
    //             <Text>{transcript}</Text>
    //           </>
    //         )}
    //       </Box>
    
    //       <Box id="speechTimestamps">
    //         {speechTimestamps.map((timestamp, index) => (
    //           <Text key={index}>{timestamp}</Text>
    //         ))}
    //       </Box>
    ...
    //       <Box id="generatedResponses">
    //         <Heading size="md">Generated Responses:</Heading>
    //         {generatedResponses.map((response, index) => (
    //           <Text key={index}>{response}</Text>
    //         ))}
    //       </Box>
    
    //       <Heading size="md">Review and Modify Agreements:</Heading>
    //       <FormControl as="form" action="/modify" method="POST" encType="multipart/form-data">
    //         <FormLabel>Upload Audio Feedback:</FormLabel>
    //         <Input type="file" name="audio_feedback" accept=".mp3, .wav, .ogg" />
    //         <Button mt={2} type="submit">Upload Audio Feedback</Button>
    //       </FormControl>
    
    //       <Box>
    //         <Heading size="md">AI Suggestions:</Heading>
    //         <Text>AI-generated suggestions based on user feedback will display here</Text>
    //       </Box>
    
    //       <Box>
    //         <Button onClick={openSign}>Click Here To Sign</Button>
    //         <Button as="a" href="/download" ml={4}>Download Customized Agreements</Button>
    //       </Box>
    
    //       <Box>
    //         <Heading size="md">Future Features:</Heading>
    //         <UnorderedList className="future-features">
    //           <ListItem>Live translation</ListItem>
    //           <ListItem>Read agreements aloud</ListItem>
    //           <ListItem>Auto-sign certain documents</ListItem>
    //           <ListItem>Remove signatures</ListItem>
    //           <ListItem>Manage document collections</ListItem>
    //         </UnorderedList>
    //       </Box>
    //     </VStack>
    //   );
